...
public class TaskManagerTest {
    ...
    public void testUpdateTask() {
        ...
        final Task updatedTask = taskManager.updateTask(taskDTO);
        ...
        final Task updatedTask2 = taskManager.updateTask(taskDTO);

        // Verify that the description was updated
        assertAll(
            () -> assertEquals("Updated Title", updatedTask2.getTitle()),
            () -> assertEquals("Updated Description", updatedTask2.getDescription()),
            () -> assertEquals(LocalDate.now(), updatedTask2.getDueDate()),
            () -> assertEquals(Priority.MEDIUM, updatedTask2.getPriority())
        );

        taskDTO = new TaskDTO(task);
        taskDTO.setDueDate(LocalDate.now().plusDays(1));
        final Task updatedTask3 = taskManager.updateTask(taskDTO);

        // Verify that the dueDate was updated
        assertAll(
            () -> assertEquals("Updated Title", updatedTask3.getTitle()),
            () -> assertEquals("Updated Description", updatedTask3.getDescription()),
            () -> assertEquals(LocalDate.now().plusDays(1), updatedTask3.getDueDate()),
            () -> assertEquals(Priority.MEDIUM, updatedTask3.getPriority())
        );

        taskDTO = new TaskDTO(task);
        taskDTO.setPriority(Priority.LOW);
        final Task updatedTask4 = taskManager.updateTask(taskDTO);

        // Verify that the priority was updated
        assertAll(
            () -> assertEquals("Updated Title", updatedTask4.getTitle()),
            () -> assertEquals("Updated Description", updatedTask4.getDescription()),
            () -> assertEquals(LocalDate.now().plusDays(1), updatedTask4.getDueDate()),
            () -> assertEquals(Priority.LOW, updatedTask4.getPriority())
        );


        taskDTO = new TaskDTO(task.getId(), "Updated Title2", "Updated Description2", LocalDate.now().plusDays(5), Priority.HIGH);
        final Task updatedTask5 = taskManager.updateTask(taskDTO);

        // Verify that all attributes were updated
        assertAll(
            () -> assertEquals("Updated Title2", updatedTask5.getTitle()),
            () -> assertEquals("Updated Description2", updatedTask5.getDescription()),
            () -> assertEquals(LocalDate.now().plusDays(5), updatedTask5.getDueDate()),
            () -> assertEquals(Priority.HIGH, updatedTask5.getPriority())
        );
    }
